...
# Terms of Service of EPIC Helper

EPIC Helper team ("us", "we" or "our") owns and operates EPIC Helper (the "Bot" or "Service"). Please read these Terms of Service (the "Terms") before using the Service.
...
- You will not trade or sell in-game currencies for anything outside the Bot.
...
# Privacy Policy for IDLE Helper
...
We collect certain information from our users, this information is security saved and protected.
...
This information is used for the functionality of the Bot, such as reminders, training helper, pet helper, guild reminder, etc.

Discord usernames and discriminators may be displayed in account settings and other features of the Bot, which all users have access to.
This collected information is not shared with anyone else.

### Contact

For any concerns about this policy or the Bot's operation, please request in the Official Discord Server of IDLE Helper: https://discord.gg/magXasew7C

Any of this data, besides the Discord user ID (which is kept for the sole reason to prevent exploits), can be requested to be removed through the official Discord Server. By doing this, all your data will be removed from the database. If you want to also get this information removed from database backups, please include it in the request. It may take up to 7 days for this information to get removed.

This Privacy Policy may be updated from time to time. Any changes made will be previously notified through the Bot and/or the Official Discord Server of IDLE Helper